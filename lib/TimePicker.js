(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'moment', 'react-dom', 'melon-core/InputComponent', 'melon-core/classname/cxBuilder', 'melon-core/Validity', 'melon-core/util/syncPropsToState', 'melon/Icon', 'melon/Confirm', './timepicker/Panel', './babelHelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('moment'), require('react-dom'), require('melon-core/InputComponent'), require('melon-core/classname/cxBuilder'), require('melon-core/Validity'), require('melon-core/util/syncPropsToState'), require('melon/Icon'), require('melon/Confirm'), require('./timepicker/Panel'), require('./babelHelpers'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.moment, global.reactDom, global.InputComponent, global.cxBuilder, global.Validity, global.syncPropsToState, global.Icon, global.Confirm, global.Panel, global.babelHelpers);
        global.TimePicker = mod.exports;
    }
})(this, function (exports, _react, _moment, _reactDom, _InputComponent2, _cxBuilder, _Validity, _syncPropsToState, _Icon, _Confirm, _Panel, babelHelpers) {
    'use strict';
    ...
    var TimePicker = function (_InputComponent) {
        ...
        TimePicker.prototype.render = function render() {
            ...
            var disabled = props.disabled,
                ...
                others = babelHelpers.objectWithoutProperties(props, ['disabled', 'readOnly', 'name', 'placeholder', 'timeFormat', 'labelFormat']);
