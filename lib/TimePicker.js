(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'moment', 'melon-core/InputComponent', 'melon-core/classname/cxBuilder', 'melon/Icon', 'melon/Confirm', './timepicker/Panel', 'lodash/omit', './babelHelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('moment'), require('melon-core/InputComponent'), require('melon-core/classname/cxBuilder'), require('melon/Icon'), require('melon/Confirm'), require('./timepicker/Panel'), require('lodash/omit'), require('./babelHelpers'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.moment, global.InputComponent, global.cxBuilder, global.Icon, global.Confirm, global.Panel, global.omit, global.babelHelpers);
        global.TimePicker = mod.exports;
    }
})(this, function (exports, _react, _moment, _InputComponent2, _cxBuilder, _Icon, _Confirm, _Panel, _omit, babelHelpers) {
    'use strict';
    ...
    var TimePicker = function (_InputComponent) {
        ...
        function TimePicker(props, context) {
            ...
            _this.state = babelHelpers['extends']({}, _this.state, {
                ...
                value: value === void 0 ? _this.stringifyValue(defaultValue) : _this.stringifyValue(value),

                // 缓存用户在 confirm 前的选中值
                time: value ? _this.parseValue(value) : void 0,
