(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'moment', 'melon-core/classname/cxBuilder', 'melon-core/util/array', 'melon/common/util/dom', '../util', './ClockItem', './ClockHand', '../babelHelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('moment'), require('melon-core/classname/cxBuilder'), require('melon-core/util/array'), require('melon/common/util/dom'), require('../util'), require('./ClockItem'), require('./ClockHand'), require('../babelHelpers'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.moment, global.cxBuilder, global.array, global.dom, global.util, global.ClockItem, global.ClockHand, global.babelHelpers);
        global.Clock = mod.exports;
    }
})(this, function (exports, _react, _moment, _cxBuilder, _array, _dom, _util, _ClockItem, _ClockHand, babelHelpers) {
    'use strict';
    ...
    var TimePickerClock = function (_Component) {
        ...
        TimePickerClock.prototype.shouldComponentUpdate = function shouldComponentUpdate(nextProps) {
            ...
            return !Util.isSame(time, nextProps.time) || mode !== nextProps.mode || !(0, _moment2['default'])(begin).isSame(nextProps.begin) || !(0, _moment2['default'])(end).isSame(nextProps.end);
        };
        ...
        TimePickerClock.prototype.renderItems = function renderItems() {
            ...
            return items.map(function (number) {
                ...
                var itemTime = timeMoment.toDate();
